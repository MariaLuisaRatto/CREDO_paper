...
![Screenshot of the CREDOgui. In the CREDOgui the dependencies among the different layers are more stringent, specifically any layer depends on the previous one](Figs/figs3.png){ width=20% }
